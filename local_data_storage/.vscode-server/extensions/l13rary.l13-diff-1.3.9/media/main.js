(function () {
    ...
    ***************************************************************************** */
    ...
    var styles = {
        ...
        "l13-diff-navigator/l13-diff-navigator.css": ":host{display:block;position:relative;transform:translate3d(0, 0, 0);user-select:none}#slider{background-color:var(--vscode-scrollbarSlider-background);box-sizing:border-box;height:10;position:absolute;right:0;top:0;transform:translate3d(0, 0, 0);width:30px;z-index:1}#slider:hover{background-color:var(--vscode-scrollbarSlider-hoverBackground)}#slider:active{background-color:var(--vscode-scrollbarSlider-activeBackground)}#ruler{display:block;position:absolute;right:30px;top:0;z-index:0}#map{display:block;opacity:.7;position:absolute;right:0;top:0;z-index:0}",
    ...
    var templates = {
        ...
        "l13-diff-navigator/l13-diff-navigator.html": "<canvas id=\"ruler\"></canvas><canvas id=\"map\"></canvas><div id=\"slider\"></div>",
    ...
    function init$8({ diff, leftVM, rightVM, panelVM, listVM }) {
        msg.on('cancel', () => diff.enable());
        msg.on('update:paths', (data) => {
            var _a, _b;
            if (panelVM.loading || listVM.hasUpdateRequest())
                return;
            if (data.uris.length) {
    ...
    function init$5({ navigator, list }) {
        ...
        if (isMacOs) {
            navigator.addEventListener('wheel', (event) => {
    ...
    let L13DiffComponent = class L13DiffComponent extends L13Element {
        ...
        initCommandsAndEvents() {
            ...
            init$8({ diff, leftVM, rightVM, panelVM, listVM });
        }
        enable() {
...
Modified: ${formatDate(new Date(stat.mtime))}`;
    ...
    let L13DiffNavigatorComponent = class L13DiffNavigatorComponent extends L13Element {
        ...
        calcSliderY(y) {
            if (y < 0)
                y = 0;
            else if (y > this.sliderMaxY)
                y = this.sliderMaxY;
            if (this.previousSliderY === y)
                return;
    ...
    ], L13DiffNavigatorComponent.prototype, "slider", void 0);
